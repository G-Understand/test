...
namespace tryMJcard
{
    class LogManagerSimple : Singleton<LogManagerSimple>
    {
        public void Log(System.Type t, object msg)
        {
            Console.WriteLine("log:" + DateTime.Now.ToString("yyyy/MM/dd hh:mm:ss") + "   class=>" + t.ToString() + "  msg=>" + msg);
        }
        ...
        public static void WriteLog_Gui(string info,string name)
        {
            ILog logger = CustomRollingFileLogger.GetCustomLogger(name);
            logger.Debug(info);
//             if (loginfo_gui.IsInfoEnabled)
//             {
//                 loginfo_gui.Info(info);
//             }
        }
